    ...
    <main>
      <section className='flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto'>
        <h1 className='text-slate-700 font-bold text-3xl lg:text-6xl'>
          Find the home of your <span className='text-slate-500'>dreams</span> in just a few clicks
        </h1>
        <div className='text-gray-400 text-xs sm:text-sm'>
          <p>We are the best choice to find your perfect place to live.</p>
        </div>
        <Link
          className='text-xs sm:text-sm
          text-blue-500 hover:text-blue-700 font-semibold'
          to={'/search'}>Discovery ours houses...</Link>
      </section>
